							...
							<!-- Post -->
								<article class="is-post is-post-excerpt">
									<header>
										...
										<span class="byline"><?php if(isset($tasks)) echo 'Below are some of your current tasks.'; else 'You currently have no task. <a href="/manage/create/">Create One</a>'?></span>
									</header>
								</article>	
						...
						<!-- Nav -->
							<nav id="nav">
                                ...
                                <li ><a href="/manage/create/">Create Tasks</a></li>
                                	<li class="current_page_item"><a href="">Current Tasks</a></li>
