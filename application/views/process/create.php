	...
	<div class="row-fluid">
        <div class="span4">
            <ul class="nav nav-tabs nav-stacked affix-top" style="background-color:rgb(245, 245, 245)">
                          ...
                          <li class="disabled" style="color:#006600; font-size:18px; text-decoration:none;"><a  style="text-decoration:none; color:#DC615A">Welcome To Shwcase</a></li>
                           <li class="<?php if(isset($tab_home)) echo $tab_home; ?>"  ><a  href="#home" data-toggle="tab"><i class="icon-"></i><i class="icon-chevron-right pull-right"></i>  1. Introduction</a></li> 
                           <li class="<?php if(isset($tab_contact)) echo $tab_contact; ?>"  ><a  href="#contact" data-toggle="tab"><i class="icon-"></i><i class="icon-chevron-right pull-right"></i>  2. Tell Us About Yourself</a></li>
                           <li class="<?php if(isset($tab_about)) echo $tab_about; ?>"  ><a  href="#about" data-toggle="tab"><i class="icon-"></i><i class="icon-chevron-right pull-right"></i>  3. What's Your Story</a></li>
                           <li class="<?php if(isset($tab_feeds)) echo $tab_feeds; ?>"  ><a  href="#feeds" data-toggle="tab"><i class="icon-"></i><i class="icon-chevron-right pull-right"></i>  4. Add Your Social Media </a></li>
                           
                           <li class="disabled" style="color:#006600; font-size:18px; text-decoration:none;"><a style="text-decoration:none; color:#DC615A">Setup Your Content</a></li>
                           <li class="<?php if(isset($tab_music)) echo $tab_music; ?>" ><a  href="#music" data-toggle="tab"><i class="icon-"></i><i class="icon-chevron-right pull-right"></i>  5. Share Your Music</a></li>
                            <li class="<?php if(isset($tab_picture)) echo $tab_picture; ?>"  ><a  href="#app" data-toggle="tab"><i class="icon-"></i><i class="icon-chevron-right pull-right"></i> 6. Edit App Store Information</a></li>
                            <li class="<?php if(isset($tab_themes)) echo $tab_themes; ?>"  ><a  href="#theme" data-toggle="tab"><i class="icon-"></i><i class="icon-chevron-right pull-right"></i>  7. Edit Your Theme Colors</a></li>
                           
                           <li  style="color:#DC615A; font-size:18px; text-decoration:none;" class="<?php if(isset($tab_livevideo)) echo $tab_livevideo; ?>"  ><a  href="#livevideo" data-toggle="tab"  style="color:#DC615A;"><i class="icon-chevron-right pull-right"></i> Preview & Approve</a></li>
                       </ul>
                       <ul  class="nav nav-tabs nav-stacked affix-top" style="background-color:rgb(245, 245, 245)">
                       <li class="disabled" style="color:#333; font-size:18px; text-decoration:none;"><a style="text-decoration:none; color:#333">Optional</a></li>
                           <li class="<?php if(isset($tab_links)) echo $tab_links; ?>"  ><a  href="#links" data-toggle="tab"><i class=" icon-folder-close"></i><i class="icon-chevron-right pull-right"></i>  Add Links</a></li>
                           <li class="<?php if(isset($tab_event)) echo $tab_event; ?>"  ><a  href="#calendar" data-toggle="tab"><i class="icon-calendar"></i><i class="icon-chevron-right pull-right"></i>  Add Events</a></li>
         ...
         <div class="span8 tab-content" id="settings" style="background-color:rgb(245, 245, 245); padding:20px">
              ...
              <div class="<?php if(isset($tab_home)) echo $tab_home; ?>  row-fluid tab-pane fade" id="home" style="width:100%;">
                  	<div style="width:100%; text-align:center">
                        <h1>Welcome to Shwcase!</h1>
                        <p> We will walk you through creating your own personal music mobile app and website.</p>
                        <iframe class="youtube-player" type="text/html" width="300" height="168" src="http://www.youtube.com/embed/VIDEO_ID" allowfullscreen frameborder="0"></iframe>    
                        <br />
                          ...
                          <div class="tabbable"> <!-- Only required for left/right tabs -->
                              ...
                              <div class="tab-content">
                                ...
                                <div class="tab-pane" id="addmusic">
                                    <form action="/entertainment/add_record_songs2/<?php if(isset($App_ID)) echo $App_ID; ?>" enctype="multipart/form-data" method="POST" >
                                <div style="width:100%; vertical-align:middle">
...
<div style="margin-top: 20px;">
                      ...
                      <form action="/entertainment/edit_song2/<?php if(isset($App_ID)) echo $App_ID; ?>" enctype="multipart/form-data" method="POST" > 
                  ...
                  <div class="<?php if(isset($tab_themes)) echo $tab_themes; ?> row-fluid tab-pane fade" id="theme" style="width:100%;">
                         <div style="width:100%; text-align:center; padding-bottom:;">
                            ...
                            <p>Here you can change content colors of your application.</p>
                             ...
                             <label style="display:  block; clear: both; margin-top: 20px; width:100%; text-align:center;">  
                               <span style="position: relative; top: 4px;font-size: 18px;font-weight: bold; margin-left: 0px;margin-right: 0px;">   Tab Bar Select Button:  </span>  
                                    ...
                                    <span class="add-on"><i style="background-color: <?php if(isset($rgba_tabbar)) echo $rgba_tabbar; ?>"></i></span>
                                                    <input type="text" style="display:none;" class="box" id="tabbar_stored" value="<?php if(isset($json_tabbar)) echo $json_tabbar; ?>">
                                      </div> 
                                  </label>
				...
				<span class="add-on"><i style="background-color: <?php if(isset($rgba_tabbar_select_button)) echo $rgba_tabbar_select_button; ?>;"></i></span>
                                <input type="text" style="display:none;" class="box" id="tabbar_select_button_stored" value="<?php if(isset($json_tabbar_select_button)) echo $json_tabbar_select_button; ?>">
                        </div> </label>
                           <label style="display:  block; clear: both; width:100%; text-align:center; margin-top: 20px;">   
                               <span style="position: relative; top: 4px;font-size: 18px;font-weight: bold; margin-left: 0px;margin-right: 0px;">   Tab Bar Text:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span> 
				...
				<span class="add-on"><i style="background-color: <?php if(isset($rgba_tabbar_select_text)) echo $rgba_tabbar_select_text; ?>;"></i></span>
                                <input type="text" style="display:none;" id="tabbar_select_text_stored" value="<?php if(isset($json_tabbar_select_text)) echo $json_tabbar_select_text; ?>">
                        </div> </label>
                           <label style="display:  block; clear: both; width:100%; text-align:center; margin-top: 20px;">   
                               <span style="position: relative; top: 4px;font-size: 18px;font-weight: bold; margin-left: 2px; margin-right: 0px;">    Background:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   </span> 
				...
				<span class="add-on"><i style="background-color: <?php if(isset($rgba_background)) echo $rgba_background; ?>;"></i></span>
                                <input type="text" style="display:none;" id="background_stored" value="<?php if(isset($json_background)) echo $json_background; ?>">
                        </div> </label>
                           <label style="display:  block; clear: both; width:100%; text-align:center; margin-top: 20px;">   
                               <span style="position: relative; top: 4px;font-size: 18px;font-weight: bold; margin-left: 0px;margin-right: 0px;">   List Background:&nbsp;&nbsp   </span>  
				...
				<span class="add-on"><i style="background-color: <?php if(isset($rgba_list_background)) echo $rgba_list_background; ?>;"></i></span>
                                <input type="text" style="display:none;" id="list_background_stored" value="<?php if(isset($json_list_background)) echo $json_list_background; ?>">
                        </div> </label>  
                           <label style="display:  block; clear: both; width:100%; text-align:center; margin-top: 20px;">   
                               <span style="position: relative; top: 4px;font-size: 18px;font-weight: bold; margin-left: 0px; margin-right: 0px;">   Text:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;      </span>  
				...
				<span class="add-on"><i style="background-color: <?php if(isset($rgba_text_color)) echo $rgba_text_color; ?>;"></i></span>
                                <input type="text" style="display:none;" id="text_color_stored" value="<?php if(isset($json_text_color)) echo $json_text_color; ?>">
                        </div> </label>
...
<option value="Zapfino">Zapfino</option>
                        ...
                        <span style="font-family: arial; font-size: 18px; margin-left: 10px;" id="font_example">Hello World</span>
                           ...
                           <button class="btn btn-success" id="sumbit_theme" style="clear: both;margin-top: 30px;float: right;">Save</button>
                  ...
                  <div class="<?php if(isset($tab_feeds)) echo $tab_feeds; ?>  row-fluid tab-pane fade" id="feeds" style="width:100%;">
                  	<div style="width:100%; text-align:center">
                        ...
                        <p>Combine your social media accounts in one location.</p>
                        ...
                        <div style="width:100%; vertical-align:middle">
                            <div style="font-size:18px; font-weight:bold;">Twitter Username
                           	...
                           	<div style="width:100%; vertical-align:middle">
                            <div style="font-size:18px; font-weight:bold;">Youtube Username<input  id="youtube_username" placeholder="Youtube Username" type="text" value="<?php if(isset($youtube)) echo $youtube; ?>"  style="margin-left:10px; color:#666"/>
                                </div>
                  ...
                  <div class="<?php if(isset($tab_app)) echo $tab_app; ?> row-fluid tab-pane fade" id="app" style="width:100%;">
                  	<div style="width:100%; text-align:center">
                        <h1>App & Website Setup</h1>
                       <p>Here you can edit your app & website information.</p>
                        
                        
                           <form name="edit_form" action="/app/pay_change2" enctype="multipart/form-data" method="post">

                               
                                  <div class="span4">
                    <label>App's Icon Image: </label> 

                    <img src='<?php if(isset($edit['icon'])) echo $edit['icon']; ?>' class='img-rounded' style="height: 150px; width: 150px;" />
...
<br />
                    ...
                    <img src='<?php if(isset($edit['default'])) echo $edit['default']; ?>' class='img-rounded' style="height: 225px; width: 150px;" />
           ...
           <div class="span7">
           		<div id="input_container" align="left">
                    <label>Name: &nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="text" name="name" placeholder="Type Name" value="<?php if(isset($edit['name'])) echo $edit['name']; ?>" /></label>
                    
                    <label>Nickname:<input name="nickname" type="text" placeholder="Type Nickname" value="<?php if(isset($edit['nickname'])) echo $edit['nickname']; ?>" /></label> 
                    
                    <label>Keywords:<input name="keywords" type="text" placeholder="Type Keywords" value="<?php if(isset($edit['keywords'])) echo $edit['keywords']; ?>" maxlength="100" /></label> 
                    
                    <label>Website:&nbsp;&nbsp;&nbsp;<input name="web_ext" type="text" placeholder="Site Ext" style="width:100px;" id="web_ext" value="<?php if(isset($genre['web_ext'])) echo $genre['web_ext']; ?>" maxlength="100" />.shwcase.co&nbsp;</label> 
                    <label>Description: 
                 
                   <textarea name="description" id="description" placeholder="Change Me"><?php if(isset($edit['description'])) echo $edit['description']; else echo 'With this app you can stay up to date with all the latest content, be informed, receive notifications and interact with the artist as well as other fans. 
...
Notes- 
Please have wifi for the best performance'?></textarea></label>
                  <div id="picture_bad" class="alert alert-danger" style="display: none; margin-top: 20px;"></div>
                    ...
                    <input type="submit" value="Save" class="btn btn-medium btn-success" />
                    <br />
                    <br />
                ...
                <div class="modal-footer">
                  ...
                  <div class="<?php if(isset($tab_event)) echo $tab_event; ?> row-fluid tab-pane fade" id="calendar" style="width:100%;">
                    ...
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                         ...
                         <form style="margin: 0px;" action="/entertainment/add_event2/<?php if(isset($App_ID)) echo $App_ID; ?>" method="POST">
                              <div class="modal-body">
                    ...
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                         ...
                         <form style="margin: 0px;" action="/entertainment/edit_event2/<?php if(isset($App_ID)) echo $App_ID; ?>" method="POST">
                              <div class="modal-body">
                  ...
                  <div class="<?php if(isset($tab_livevideo)) echo $tab_livevideo; ?>row-fluid tab-pane fade" id="livevideo" style="width:100%;">
                  	<div style="width:100%; text-align:center">
                        <h1>Check It Out</h1>
                        <p>Here you can use the links below to preview your app and website.</p>
                        
                        	<div class="row-fluid" align="center">
                            	<div class="span6" align="center">
                                	<iframe class="youtube-player" type="text/html" width="100%" src="http://www.youtube.com/embed/VIDEO_ID" allowfullscreen frameborder="0"></iframe> 
                            		<input class="btn btn-medium btn-primary" value="Checkout Your Website" style="margin-bottom:10px" onclick="gotoSite()"/>
                                </div>
                                <div class="span6" align="center">
                                <iframe class="youtube-player" type="text/html" width="100%" src="http://www.youtube.com/embed/VIDEO_ID" allowfullscreen frameborder="0"></iframe> 
                                <a href="https://itunes.apple.com/us/app/shwcase-artist-portal/id649679350?ls=1&mt=8"><input class="btn btn-medium btn-info" value="Preview Your App" style="margin-bottom:10px" /></a>
                                </div>
                          	</div>
                            
                            <br />
                            <h3>Happy with how everything looks?</h3>
                            
                            <input class="btn btn-large btn-success" value="Approve & Submit" onclick="submitapp()" style="margin-bottom:10px" />
                  ...
                  <div class="<?php if(isset($tab_about)) echo $tab_about; ?> row-fluid tab-pane fade" id="about" style="width:100%;">
                  	<div style="width:100%; text-align:center">
                        ...
                        <p>Here you add your bio section.</p>
                            <div style="width:100%; vertical-align:middle">
                  ...
                  <div style="width:100%; text-align:center">
                        ...
                        <p>Here you add your basic contact information.</p>           
                           <div style="width:100%; vertical-align:middle;">
                            <div style="font-size:18px; font-weight:bold;">Genre &nbsp;&nbsp;&nbsp;<input id="genre" placeholder="genre" type="text" value="<?php if(isset($genre['genre'])) echo $genre['genre']; ?>"  style="margin-left:10px; color:#666"/> </div>
