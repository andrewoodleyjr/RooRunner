...
class entertainment extends check
{
	...
	public function web_ext($App_ID){
          try
            {
            
            $this->load->model('model_users');
            $return = $this->model_users->updatewebsite($this->session_data);     
	...
	public function web_ext2($App_ID){
          try
            {
            
            $this->load->model('model_users');
            $return = $this->model_users->updatewebsite2($this->session_data);     
         ...
         try
           {
             ...
             redirect("/app/manage_app/music", "refresh");
             return true;                
             endif;
           }
           catch(Exception $e)
	...
	public function add_record_songs2($App_ID)
    {
         try
           {
             ...
             if($recorded == true):
             $this->load->helper('url');
             redirect("/process/start/music", "refresh");
             return true;                
             endif;
           }
           catch(Exception $e)
	...
	public function edit_song2($App_ID)
    {
        try{
            $edited = $this->entertain_model->edit_music();
            if($edited):
     ...
     try
        {
          ...
          $this->load->helper('url');
          redirect("/app/manage_app/event", 'refresh');
          return true;
        }
        catch(Exception $e)
        {
	...
	public function add_event2($App_ID)
    {
     try
        {
           ...
           $this->entertain_model->add_event();
          $this->load->helper('url');
          redirect("/process/start/event", 'refresh');
          return true;
        }
        catch(Exception $e)
        {
    ...
    public function edit_event2($App_ID)
     {
       try
        {
